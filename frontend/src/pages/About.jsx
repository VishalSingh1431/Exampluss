  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center mb-16">
        <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-4">About ExamPluss</h1>
      ...
      {/* Features Section */}
      <div className="mb-20">
        <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Why Choose ExamPluss</h2>
      ...
      {/* Stats Section */}
      <div className="bg-blue-50 rounded-xl p-8 sm:p-12 mb-20">
