...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-[#008080]/10 to-white py-16 px-4 border-b border-gray-100">
        <div className="container mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 text-[#008080]">
            Master Competitive Exams with <span className="text-[#008080]">Real Previous Papers</span>
          </h1>
            ...
            {suggestions.length > 0 && (
              <div className="absolute z-10 w-full mt-1 bg-white rounded-lg shadow-lg border border-gray-200 max-h-60 overflow-auto">
                {suggestions.map((exam, index) => (
                  <div 
                    key={index}
                    className="px-4 py-3 hover:bg-[#008080]/10 cursor-pointer border-b border-gray-100 last:border-b-0"
                    onClick={() => {
                      setSearchQuery(exam);
                      setSuggestions([]);
                    }}
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button className="bg-[#008080] hover:bg-[#006666] text-white font-bold py-3 px-8 rounded-lg transition duration-300 shadow-md hover:shadow-lg">
              Start Practicing Now
            </button>
            <button className="bg-white border-2 border-[#008080] text-[#008080] hover:bg-[#008080]/10 font-bold py-3 px-8 rounded-lg transition duration-300">
              Browse All Exams
            </button>
          </div>
        </div>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#008080] mb-3">Explore Popular Exams</h2>
            ...
            {featuredExams.map((exam, index) => (
              <div key={index} className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition duration-300 border border-gray-100">
                <div className="flex items-start">
                  <div className="text-4xl mr-4 text-[#008080]">{exam.icon}</div>
                  <div>
                    <h3 className="text-xl font-bold text-[#008080] mb-2">{exam.name}</h3>
                    <div className="flex flex-wrap gap-2 mt-3">
                      {exam.subjects.map((subject, i) => (
                        <span key={i} className="bg-[#008080]/10 text-[#008080] px-3 py-1 rounded-full text-sm">
                          {subject}
                        </span>
                      ))}
                    </div>
                    <button className="mt-4 text-[#008080] hover:text-[#006666] font-medium flex items-center">
      ...
      <section className="py-16 px-4 bg-[#008080]/10">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-[#008080] mb-3">Why Practice with Actual Exam Papers?</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            <div className="bg-white p-8 rounded-xl shadow-sm">
              <h3 className="text-xl font-bold text-[#008080] mb-4">Our Advanced Paper Viewer</h3>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm">
              <h3 className="text-xl font-bold text-[#008080] mb-4">Smart Analysis Tools</h3>
              <ul className="space-y-4">
                <li className="flex items-start">
                  <span className="text-[#008080] mr-2">✓</span>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#008080] mb-3">Why ExamPluss</h2>
            <p className="text-gray-500 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <div key={index} className="bg-white p-6 rounded-lg border border-gray-200 hover:border-[#008080] transition duration-300">
                <div className="text-3xl mb-4 text-[#008080]">{feature.icon}</div>
                <h3 className="text-xl font-bold mb-3 text-[#008080]">{feature.title}</h3>
